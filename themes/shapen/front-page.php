<?php get_header(); ?>
    ...
    <div class="page-content">
                    ...
                    <div class="row">
                    	<div class="col-lg-3 col-md-4 col-sm-6 m-b30">
                            ...
                            <div class="image-effect-one hover-shadow">
                                ...
                                <div class="figcaption">
                                    ...
                                    <a href="index.html#"><i class="link-plus bg-primary"></i></a>
                                </div>
                    	...
                    	<div class="col-lg-3 col-md-12 col-sm-6 m-b30">
                            ...
                            <div class="mt-box our-speciallization-content">
                                ...
                                <a class="site-button btn-effect">View All</a>
                            </div> 
                            ...
                            <div class="col-md-3 col-sm-12">
                            	<div class="about-home-right bg-white p-a30">
                                    ...
                                    <div class="text-right">
                                        <a href="index.html#" class="site-button-link" data-hover="Read More">Read More <i class="fa fa-angle-right arrow-animation"></i></a>
                                    </div>                                                    
                                </div>
                            </div>
                		</div>
					...
					<div class="section-content">
                    	<div class="row">
                        	<div class="col-md-4 col-sm-12">
                                ...
                                <div class="video-section-full bg-no-repeat bg-cover overlay-wraper" style="background-image:url('images/video-bg.jpg')">
			...
			<div class="section-content">
                <div class="container">
                    ...
                    <div class="row">
                    	<div class="col-md-4 col-sm-6">
                        	<div class="mission-left bg-white m-b30 p-a30 bg-no-repeat bg-bottom-left" style="background-image:url('images/background/bg-site.png');">
                                ...
                                <ul class="list-angle-right anchor-line">
                                    <li><a href="index.html#">Construction Management</a></li>
                                    <li><a href="index.html#">Pre Construction Services</a></li>
                                    <li><a href="index.html#">Contract Administration</a></li>
                                    <li><a href="index.html#">Implementation</a></li>
                                    <li><a href="index.html#">Leed consultation</a></li>
                                </ul>
                                <div class="text-right">
                                	<a href="index.html#" class="site-button-link" data-hover="Read More">Read More <i class="fa fa-angle-right arrow-animation"></i></a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="mission-mid bg-no-repeat bg-cover m-b30" style="background-image:url('images/mission.jpg');"></div>
                        </div>
        ...
        <div class="section-full mobile-page-padding p-tb80 overlay-wraper bg-cover bg-center" style="background-image:url('images/background/bg-1.jpg')">
            ...
            <div class="container">
					...
					<div class="section-content">
						<div class="call-us-section text-center">
                            ...
                            <a href="index.html#" class="site-button-secondry btn-effect bg-dark">Contact Us</a>
						</div>
					</div>
                            ...
                            <div class="stamp col-md-3 col-sm-6 m-b30">
                                <div class="bg-gray p-a30">
                                    <div class="filter-wrap">    
                                            ...
                                            <li class="active"><a data-filter="*" data-hover="All" href="index.html#">All</a></li>
        ...
        <!-- OUR PROJECT END -->
         ...
         <!-- OUR BLOG START -->
         <div class="section-full mobile-page-padding p-t80 p-b30 square_shape1 bg-parallax bg-cover"  data-stellar-background-ratio="0.5" style="background-image:url('images/background/bg5.jpg');">
                    <div class="container">
                        ...
                        <div class="section-head ">
                            <div class="mt-separator-outer separator-center">
                                <div class="mt-separator">
                                    <h2 class="text-white text-uppercase sep-line-one "><span class="font-weight-300 text-primary" >Latest</span> Blog</h2>
                                </div>
                            </div>
                        </div>                   
                        <!-- TITLE END --> 
                                            ...
                                            <div class="post-overlay-position">
                                                <div class="mt-post-meta ">
                                                    <ul>
                                                        ...
                                                        <li class="post-comment"><a href="javascript:;">2 comment</a> </li>
                                                    </ul>
                                                </div>                                        
                                                <div class="mt-post-title ">
                                                    <h4 class="post-title m-b0">Commercial design for project</h4>
                                                </div>
                                                <div class="mt-post-text">
                                                    <p>Which is the same as saying through shrinking from toil and pain.</p> 
                                                </div>
                                                <div class="readmore-line">
                                                    <span><a href="index.html#" class="site-button-link" data-hover="Read More">Read More <i class="fa fa-angle-right arrow-animation"></i></a></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-box blog-post latest-blog-3 date-style-1 bg-white m-b30">
                                        ...
                                        <div class="mt-post-info p-a30">
                                            <div class="post-overlay-position">
                                                <div class="mt-post-meta ">
                                                    <ul>
                                                        <li class="post-date"><strong class="text-primary">16</strong> <span>Feb 2019</span></li>
                                                        <li class="post-author">By <a href="javascript:;">Admin</a> </li>
                                                        <li class="post-comment"><a href="javascript:;">2 comment</a> </li>
                                                    </ul>
                                                </div>                                        
                                                <div class="mt-post-title ">
                                                    <h4 class="post-title m-b0">Our interior design prediction</h4>
                                                </div>
                                                <div class="mt-post-text">
                                    ...
                                    <div class="mt-box blog-post latest-blog-3 date-style-1 bg-white m-b30">
                                        ...
                                        <div class="mt-post-info p-a30">
                                            <div class="post-overlay-position">
                                                <div class="mt-post-meta ">
                                                    <ul>
                                                        <li class="post-date"><strong class="text-primary">18</strong> <span>Jan 2019</span></li>
                                                        <li class="post-author">By <a href="javascript:;">Admin</a> </li>
                                                        <li class="post-comment"><a href="javascript:;">2 comment</a> </li>
                                                    </ul>
                                                </div>                                        
                                                <div class="mt-post-title ">
                                                    <h4 class="post-title m-b0">Low cost interior designing ideas</h4>
                                                </div>
                                                <div class="mt-post-text">
                     ...
                     <div class="owl-carousel testimonial-home">
                        ...
                        <div class="item">
                            <div class="testimonial-2 m-a30  hover-animation-1">
                                <div class=" block-shadow bg-white p-a30">
                                    <div class="testimonial-detail clearfix">
                                        <div class="testimonial-pic radius shadow scale-in-center"><img src="images/testimonials/pic4.jpg" width="100" height="100" alt=""></div>
                        ...
                        <div class="item">
                            <div class="testimonial-2 m-a30  hover-animation-1">
                                <div class=" block-shadow bg-white p-a30">
                                    <div class="testimonial-detail clearfix">
                                        <div class="testimonial-pic radius shadow scale-in-center"><img src="images/testimonials/pic5.jpg" width="100" height="100" alt=""></div>
                                        <h4 class="testimonial-name m-b5">Cuthbert Brain -</h4>
                                        <span class="testimonial-position">Business Person</span>
                                    </div>                                    
                                    <div class="testimonial-text">
